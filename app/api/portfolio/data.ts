...
export const portfolioData: {
  ...
  preview: {
    ...
    challenges: [
      'WebRTC ICE 후보 교환 문제 발견 및 해결 과정에서 webrtc-internals 도구 활용',
      '백엔드 개발자와의 페어 프로그래밍을 통한 시그널링 서버 코드 수정',
      'forwardRef로 전달받는 ref 객체의 재생성으로 인한 불필요한 리렌더링 문제 해결',
      'GitHub Project를 활용한 애자일 스프린트 경험',
    ],
    mainImage: '/images/projects/preview/main.jpg',
    images: [
      '/images/projects/preview/video-call.jpg',
      '/images/projects/preview/landing-page.jpg',
      '/images/projects/preview/auth-screen.jpg',
      '/images/projects/preview/schedule-view.jpg',
    ],
    year: '2024',
    duration: '2개월',
    category: '웹 애플리케이션',
